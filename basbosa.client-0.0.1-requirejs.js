...
b)):n[a]}c&&!x(c)&&(e=c,c=void 0);d&&!x(d)&&(e=d,d=void 0);for(u();F.length;)if(f=F.shift(),f[0]===null)return B(H("mismatch","Mismatched anonymous BasbosaJs.define() module: "+f[f.length-1]));else V(f);r(g(null,e)).init(a,d,c,{enabled:!0});E();return h.require},undef:function(a){var b=g(a,null,!0),c=m[a];delete n[a];delete R[b.url];delete W[a];if(c){if(c.events.defined)W[a]=c.events;z(a)}},enable:function(a){m[a.id]&&r(a).enable()},completeLoad:function(a){var b=k.shim[a]||{},c=b.exports&&b.exports.exports,
...
BasbosaJs.define("vendors/require-2.0.4", function(){});
...
(function() {
  ...
  // backwards-compatibility for the old `BasbosaJs.require()` API. If we're not in
  ...
  // via BasbosaJs.define() happens at the end of this file.
  ...
  if (typeof BasbosaJs.define === 'function' && BasbosaJs.define.amd) {
    BasbosaJs.define('underscore',[], function() {
      return _;
    });
  }
...
(function(root, factory) {
  ...
  if (typeof exports !== 'undefined') {
    ...
    factory(root, exports, BasbosaJs.require('underscore'));
  } else if (typeof BasbosaJs.define === 'function' && BasbosaJs.define.amd) {
    // AMD
    BasbosaJs.define('backbone',['underscore', 'jquery', 'exports'], function(_, $, exports) {
...
BasbosaJs.define('collections/activities',[
        'backbone'
	], function() {
	/**
	 * The Activities list holds a non homogeneous set of activities
	 * a user is currenlty participating in
	 */
...
BasbosaJs.define('models/behaviours/uuid',[],function(){
	Uuid = {
		/*
...
BasbosaJs.define('libs/config',['underscore'], function(_) {
	var config, defaults = {
			socketUrl : '/'
	};
...
BasbosaJs.define('libs/basbosa',['./config'], function(Config) {
...
BasbosaJs.define('collections/users',[
	 '../models/user'
		, 'backbone'
	], function(UserModel) {
...
BasbosaJs.define('models/message',[
   'backbone'
	], function() {
...
BasbosaJs.define('collections/messages',[
		'../models/message'
	, 'backbone'
	], function(Message) {
...
BasbosaJs.define('models/sector',[
		'../collections/users'
...
BasbosaJs.define('collections/sectors',[
		'../models/sector'
	, 'backbone'
...
BasbosaJs.define('collections/apps',[
		'../models/app'
	], function(AppModel) {
...
BasbosaJs.define('collections/groups',[
	 '../models/group'
	, 'backbone'
	], function(GroupModel) {
...
BasbosaJs.define('libs/logging_module',['underscore', 'require', './basbosa'], function( _ , require) {
	...
	Logger.prototype.log = function (type) {
		...
		function getMyConsoleArgs (inputConsoleArgs, context) {
			...
			if (!SERVER && self.uiLogger) {
				BasbosaJs.require(['jquery'], function() {					
					if (isFirstTime == null) {
...
BasbosaJs.define('libs/leveled_events',['require', './logging_module', './basbosa'], function( require, LoggingModule) {
...
BasbosaJs.define('models/j',[
	...
	var JModel = Backbone.Model.extend({
		...
		// Used on Server only
		populateS : function() {
			var groups = BasbosaJs.require('../../config/db/groups');
			GLOBAL.j = this;
...
BasbosaJs.define('libs/app_backbone',['backbone'], function() {
...
BasbosaJs.define('libs/assets',['backbone', 'jquery', './basbosa'], function() {
...
BasbosaJs.define("libs/i18n_client", BasbosaConfig ? (BasbosaConfig.dictionaries || []) : [], function() {
...
BasbosaJs.define('themes/screen_size',[
    'jquery'
   ,'backbone'
   , '../libs/basbosa'
	], function() {
...
BasbosaJs.define('vendors/jquery.jplayer.min',['jquery'],function(b,f){b.fn.jPlayer=function(a){var c=typeof a==="string",d=Array.prototype.slice.call(arguments,1),e=this,a=!c&&d.length?b.extend.apply(null,[!0,a].concat(d)):a;if(c&&a.charAt(0)==="_")return e;c?this.each(function(){var c=b.data(this,"jPlayer"),h=c&&b.isFunction(c[a])?c[a].apply(c,d):c;if(h!==c&&h!==f)return e=h,!1}):this.each(function(){var c=b.data(this,"jPlayer");c?c.option(a||{}):b.data(this,"jPlayer",new b.jPlayer(a,this))});return e};b.jPlayer=function(a,c){if(arguments.length){this.element=
...
BasbosaJs.define('themes/feedback',[
		'require'
	,	'backbone'
	, '../libs/basbosa'
	], function(require) {
...
BasbosaJs.define("socketio", function(){});

BasbosaJs.define('controllers/components/socket_client',[
		'../../libs/leveled_events'
	, '../../libs/logging_module'
	, 'underscore'
	,	'socketio'
...
BasbosaJs.define('controllers/authn_controller',[
		'../models/user'
...
BasbosaJs.define('models/private_chat',[
	'./sector'
	, 'backbone'
	], function(SectorModel) {
...
BasbosaJs.define('controllers/chat_controller',[
		'./components/socket_client'
	, '../models/private_chat'
	, '../models/j'
...
BasbosaJs.define('controllers/sectors_controller',[
		'../models/user'
	, './components/socket_client'
	, '../models/j'
...
BasbosaJs.define('controllers/apps_controller',[
		'./components/socket_client'
	,	'../models/j'
...
BasbosaJs.define('models/network',[
    'backbone'
	], function() {
...
BasbosaJs.define('controllers/network_controller',[
		'./components/socket_client'
	,	'../models/network'
	, '../models/j'
...
BasbosaJs.define('controllers/settings_controller',[
		'./components/socket_client'
	,	'../models/j'
	], function(SocketClient, j) {
...
BasbosaJs.define('controllers/index',[
    'require'
	,	'./authn_controller'
	, './chat_controller'
	, './sectors_controller'
...
BasbosaJs.define('controllers/default_controller',[
		'./components/socket_client'
	,	'./../models/j'
	, './index'
	], function(SocketClient, j) {
...
;
BasbosaJs.define("vendors/viewporter", function(){});
...
exports.rethrow = function rethrow(err, filename, lineno){
  ...
  var context = 3
    , str = BasbosaJs.require('fs').readFileSync(filename, 'utf8')
    , lines = str.split('\n')
...
BasbosaJs.define("vendors/jade_runtime", function(){});
...
if (typeof Basbosa == 'undefined') BasbosaJs.require('app');
