...
define('models/behaviours/uuid',[],function(){
	Uuid = {
		/*
...
(function(root, factory) {
    ...
    // AMD
    define('basbosa-registry',[],function() {
	...
	Logger.prototype.log = function (type) {
		...
		Error.prepareStackTrace = function (error, frames) {
			...
			for (i = 0; i < frames.length; ++i) {
				if (!frames[i].getFileName()) return;
...
define('libs/leveled_events',['require', 'basbosa-logger', 'basbosa-registry'], function( require, LoggingModule) {
...
define('libs/app_backbone',['backbone'], function() {
...
define('libs/assets',['backbone', 'jquery', 'basbosa-registry'], function() {
...
(function(root, factory) {
  if (typeof exports !== 'undefined') {
    ...
    // AMD
    define('basbosa-config',[],function() {
      return factory(root);
    });
  } else {
    // Browser globals
...
define('vendors/jquery.jplayer.min',['jquery'],function(b,f){b.fn.jPlayer=function(a){var c=typeof a==="string",d=Array.prototype.slice.call(arguments,1),e=this,a=!c&&d.length?b.extend.apply(null,[!0,a].concat(d)):a;if(c&&a.charAt(0)==="_")return e;c?this.each(function(){var c=b.data(this,"jPlayer"),h=c&&b.isFunction(c[a])?c[a].apply(c,d):c;if(h!==c&&h!==f)return e=h,!1}):this.each(function(){var c=b.data(this,"jPlayer");c?c.option(a||{}):b.data(this,"jPlayer",new b.jPlayer(a,this))});return e};b.jPlayer=function(a,c){if(arguments.length){this.element=
...
define('controllers/chat_controller',[
		'./components/socket_client'
	, '../models/private_chat'
	, '../models/j'
...
define('controllers/sectors_controller',[
		'../models/user'
	, './components/socket_client'
	, '../models/j'
...
define('controllers/apps_controller',[
		'./components/socket_client'
	,	'../models/j'
...
define('controllers/network_controller',[
		'./components/socket_client'
	,	'../models/network'
	, '../models/j'
...
define('controllers/settings_controller',[
		'./components/socket_client'
	,	'../models/j'
	], function(SocketClient, j) {
...
;
define("vendors/viewporter", function(){});
...
define("vendors/jade_runtime", function(){});
